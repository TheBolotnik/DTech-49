                  ...
                  if (message.cost != null)
                    Consumer<ChatProvider>(
                      builder: (context, chatProvider, child) {
                        final isVsetgpt = chatProvider.isVseGPT;
                        return Text(
                          message.cost! < 0.001
                              ? isVsetgpt
                                  ? 'Стоимость: <0.001₽'
...
class ChatScreen extends StatelessWidget {
      ...
      builder: (context, chatProvider, child) {
        return Row(
          children: [
                        ...
                        Row(
                          children: [
                            ...
                            FutureBuilder<String>(
                              future: chatProvider.formatPricing(
            ...
            if (chatProvider.isModelsFallback)
              Tooltip(
                message:
                    'Резервные модели: ${chatProvider.modelsFallbackReason ?? "Ошибка загрузки"}',
                child: const Padding(
  ...
  // Отображение значка провайдера и валюты
    ...
    return Consumer<ChatProvider>(
      builder: (context, chatProvider, child) {
        return Container(
          ...
          child: Text(
            '${chatProvider.providerName} (${chatProvider.currency})',
            style: const TextStyle(
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              if (chatProvider.isLoadingBalance)
                const SizedBox(
                  width: 12,
                  height: 12,
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    await chatProvider.refreshBalance();
                  },
